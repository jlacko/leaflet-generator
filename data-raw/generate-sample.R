...
input <- data.frame(id = c("Kramářova vila", "Pražský hrad", "Strakova akademie", "Sněmovna", "Senát"),
                    ...
                    popisek = c('hnízdiště <i><a href = "https://cs.wikipedia.org/wiki/%C4%8C%C3%A1p_b%C3%ADl%C3%BD">Ciconia ciconia L. 1758</a></i>', "prezidence rezidenta", 'akademie <i><a href="https://cs.wikipedia.org/wiki/Straka_obecn%C3%A1">Pica pica L. 1758</a></i>', "dolní komora", "horní komora"))
